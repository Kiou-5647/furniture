...
class GeodataService
{
    ...
    {
        return Cache::tags([CacheTag::Geodata->value])
            ->remember(CacheTag::Geodata->key('provinces'), CacheKeys::TTL, fn () => Province::query()
                ->orderBy('name')
    ...
    {
        return Cache::tags([CacheTag::Geodata->value])
            ->remember(CacheKeys::getFiltersKeys('wards', $provinceCode), CacheKeys::TTL, fn () => Ward::query()
