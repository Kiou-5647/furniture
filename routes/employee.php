...
Route::middleware(['auth', 'verified', 'user_type:employee'])->group(function () {
    ...
    Route::middleware(['can:lookup.update'])->put('/nhan-vien/tra-cuu/{id}', [LookupController::class, 'update'])
        ->name('employee.lookups.update');

    Route::middleware(['can:lookup.delete'])->delete('/nhan-vien/tra-cuu/{id}', [LookupController::class, 'destroy'])
