...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('category_room_placement', function (Blueprint $table) {
            $table->id();
            $table->foreignUuid('category_id')->constrained()->cascadeOnDelete();
            $table->foreignUuid('room_id')->constrained('lookups')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('category_room_placement');
