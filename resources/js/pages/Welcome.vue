...
<template>
    ...
    <ShopLayout>
        ...
        <section class="relative overflow-hidden select-none">
            ...
            <div
                class="relative mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8 lg:py-40"
            >
                <div class="max-w-xl">
                    <h1
                        class="text-2xl leading-relaxed font-bold text-white sm:text-5xl lg:text-6xl"
                    >
                        Kiến tạo không gian sống
                        <span class="text-amber-400">tinh tế</span>
                    </h1>
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <Link
                            href="/san-pham"
                            class="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-zinc-900 shadow-sm transition-colors hover:bg-zinc-100"
                        >
                            Khám phá ngay
                        ...
                        <Link
                            href="#"
                            class="inline-flex items-center gap-2 rounded-lg border border-white/30 px-6 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-colors hover:bg-white/10"
                        >
                            Khuyến mãi
                        </Link>
                    </div>
        ...
        <section class="border-b bg-zinc-50">
            <div
                class="ml-6 grid max-w-7xl grid-cols-2 gap-6 px-4 py-8 sm:mx-auto sm:px-6 lg:grid-cols-4 lg:px-8"
            >
                <div
                    v-for="f in features"
                    :key="f.title"
        ...
        <!-- Rooms Carousel -->
        <section
            class="mx-auto max-w-7xl px-4 py-16 select-none sm:px-6 lg:px-8"
        >
            <div class="mb-10">
            ...
            >
                    ...
                    >
                        ...
                        >
                            <div class="relative aspect-square overflow-hidden">
                                ...
                                <div
                                    v-else
                                    class="flex h-full w-full items-center justify-center bg-zinc-200"
                                >
                                    <span
                                        class="text-2xl font-bold text-zinc-400"
                                        >{{ room.label.charAt(0) }}</span
                                    >
                                </div>
                                <div
                            ...
                            <div class="relative -mt-24 p-5">
                                <h3
                                    class="text-md font-semibold text-white sm:text-lg"
                                >
                                    {{ room.label }}
                                </h3>
                            </div>
                ...
                <CarouselPrevious
                    class="left-2 h-6 w-6 sm:flex sm:h-8 sm:w-8"
                />
                <CarouselNext class="right-2 h-6 w-6 sm:flex sm:h-8 sm:w-8" />
            </Carousel>
        </section>
        ...
        <section class="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
            <div
                class="relative overflow-hidden rounded-2xl bg-zinc-900 px-6 py-16 sm:px-12 lg:py-20"
            >
