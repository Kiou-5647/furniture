...
return [
    ...
    | về kích thước. Hãy thoải mái điều chỉnh từng thông báo này tại đây.
    |
    */
    ...
    'uppercase' => 'Trường :attribute phải được viết hoa.',
    ...
    | bằng quy ước "attribute.rule" để đặt tên các dòng. Điều này giúp nhanh chóng
    ...
    */
    ...
    | bằng một thứ gì đó dễ đọc hơn như "Địa chỉ E-Mail" thay vì "email".
    | Điều này đơn giản là giúp chúng ta làm cho thông báo của mình diễn đạt tốt hơn.
    |
    */
